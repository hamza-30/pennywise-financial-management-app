  ...
  return (
          ...
          >
            ...
            <div className={`flex justify-between items-center`}>
                ...
                <div
                 ...
                 className={`flex items-center justify-center px-2 md:w-30 h-7.5 rounded-lg gap-x-2 bg-red-50 hover:bg-red-100 active:bg-red-100 cursor-pointer text-red-500`}>
    ...
    <div
      ...
      >
        ...
        <p className={`font-medium`}>Once you delete your data, there is no going back. Please be certain.</p>
