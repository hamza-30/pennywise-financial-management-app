...
function TransactionCard({ id, desc, type, date, category, amount, editingTransaction, setEditingTransaction, setAddTransactionOpen, transaction}) {
  let {deleteTransaction} = useTransactions()
